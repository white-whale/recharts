...
function (_Component) {
  ...
  _createClass(Sector, [{
    ...
    value: function getArcFunction() {
      ...
      return arc().innerRadius(innerRadius).outerRadius(outerRadius).cornerRadius(cornerRadius).startAngle(convertToD3Angle(startAngle)).endAngle(convertToD3Angle(endAngle));
    }
  }, {
    ...
    value: function render() {
      ...
      var layerClass = classNames('recharts-sector', className); // const deltaRadius = outerRadius - innerRadius;
      ...
      if (!canvas || !canvasId) {
        ...
        return React.createElement("path", _extends({}, filterSvgAttributes(getPresentationAttributes(this.props)), filterEventAttributes(this.props), {
