  ...
  function (_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.renderGraphicChild = function (element) {
        ...
        var graphicalItem = cloneElement(element, _objectSpread({}, item.props, {
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      */
      ...
      value: function clearCanvas() {
        ...
        var canvasChart = select("canvas#".concat(canvasId));
      ...
      */
      ...
      value: function render() {
        ...
        }), this.props.canvas ? React.createElement(React.Fragment, null, React.createElement(Surface, _extends({}, attrs, {
          width: width,
          height: height
        }), this.renderClipPath(), children && children.length && renderByOrder(children.filter(function (c) {
          return c && c.type && c.type.name && map[c.type.name].layer === 'bottom';
        }), map)), this.renderCanvas(), React.createElement(Surface, _extends({}, attrs, {
          width: width,
          height: height
        }), this.renderClipPath(), children && children.length && renderByOrder(children.filter(function (c) {
          return !(c && c.type && c.type.name && map[c.type.name].layer === 'bottom');
        }), map))) : React.createElement(Surface, _extends({}, attrs, {
          width: width,
          height: height
