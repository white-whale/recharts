...
import { PRESENTATION_ATTRIBUTES, EVENT_ATTRIBUTES, LEGEND_TYPES, getPresentationAttributes, findAllByType, filterEventsOfChild, isSsr, filterSvgAttributes } from '../util/ReactUtils';
...
function (_Component) {
  ...
  _createClass(Pie, [{
    ...
    value: function renderLabels(sectors) {
      ...
      var pieProps = filterSvgAttributes(getPresentationAttributes(this.props));
    ...
    value: function renderSectors() {
      ...
      if (isAnimationActive && sectors && sectors.length && (!prevSectors || !_isEqual(prevSectors, sectors)) && !canvas) {
