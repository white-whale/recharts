...
import { PRESENTATION_ATTRIBUTES, EVENT_ATTRIBUTES, LEGEND_TYPES, filterEventAttributes, getPresentationAttributes, isSsr, findAllByType, filterSvgAttributes } from '../util/ReactUtils';
...
function (_Component) {
  ...
  _createClass(Line, [{
    ...
    value: function renderDots(needClip, clipPathId) {
      ...
      var lineProps = filterSvgAttributes(getPresentationAttributes(this.props));
