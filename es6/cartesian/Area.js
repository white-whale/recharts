...
import { PRESENTATION_ATTRIBUTES, EVENT_ATTRIBUTES, LEGEND_TYPES, getPresentationAttributes, isSsr, filterEventAttributes, filterSvgAttributes } from '../util/ReactUtils';
...
function (_Component) {
  ...
  _createClass(Area, [{
    ...
    value: function renderDots(needClip, clipPathId) {
      ...
      var areaProps = filterSvgAttributes(getPresentationAttributes(this.props));
    ...
    value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
      var _this$props5 = this.props,
          ...
          canvasId = _this$props5.canvasId;
    ...
    value: function renderArea(needClip, clipPathId) {
      var _this$props7 = this.props,
          ...
          canvas = _this$props7.canvas;
      var _this$state2 = this.state,
          prevPoints = _this$state2.prevPoints,
          prevBaseLine = _this$state2.prevBaseLine,
          totalLength = _this$state2.totalLength;

      if (isAnimationActive && points && points.length && (!prevPoints && totalLength > 0 || !_isEqual(prevPoints, points) || !_isEqual(prevBaseLine, baseLine)) && !canvas) {
