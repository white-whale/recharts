  ...
  render() {
    ...
    return (
      <div>
        ...
        <RadarChart cx={300} cy={250} outerRadius={150} width={600} height={500} data={data} canvas={useCanvas} canvasId="id1">
          <PolarGrid />
        ...
        <div style={{ width: '100%', height: '100%' }}>
          <ResponsiveContainer>
            <RadarChart data={data} canvas={useCanvas} canvasId="id3">
              <PolarGrid />
              <PolarAngleAxis dataKey="subject" />
              <PolarRadiusAxis />
              <Tooltip />
