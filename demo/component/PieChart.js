    ...
    return (
      <div className="pie-charts">
        ...
        <div className="pie-chart-wrapper">
          ...
          <PieChart width={800} height={400} canvas={useCanvas} canvasId="id1">
            <Legend paylodUniqBy />
            <Pie
              data={data01}
              dataKey="value"
        ...
        <div className="pie-chart-wrapper">
          <PieChart width={400} height={400} canvas={useCanvas} canvasId="id2">
        ...
        <div className="pie-chart-wrapper" style={{ width: '50%', height: '100%', backgroundColor: '#f5f5f5' }}>
          <ResponsiveContainer>
            <PieChart canvas={useCanvas} canvasId="id3">
        ...
        <div className="pie-chart-wrapper" style={{ width: '50%', height: '100%', backgroundColor: '#f5f5f5' }}>
          <ResponsiveContainer>
            <PieChart onMouseEnter={this.handlePieChartEnter} canvas={useCanvas} canvasId="id4">
              <Pie
                data={data01}
                dataKey="value"
                innerRadius="25%"
        ...
        <div className="pie-chart-wrapper" style={{ width: '50%', height: '100%', backgroundColor: '#f5f5f5' }}>
          <ResponsiveContainer>
            <PieChart canvas={useCanvas} canvasId="id5">
              <Pie
                data={data01}
                dataKey="value"
                innerRadius="25%"
