...
var generateCategoricalChart = function generateCategoricalChart(_ref) {
  ...
  function (_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.renderGraphicChild = function (element) {
        var item = _this.filterFormatItem(element);

        if (!item) {
          return null;
        }

        var graphicalItem = (0, _react.cloneElement)(element, _objectSpread({}, item.props, {
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      value: function componentWillUpdate(nextProps, nextState) {
        ...
        if (this.state.yAxisMap !== nextState.yAxisMap || this.state.xAxisMap !== nextState.xAxisMap || this.state.formatedGraphicalItems !== nextState.formatedGraphicalItems || this.state.graphicalItems !== nextState.graphicalItems || this.state.offset !== nextState.offset || this.state.stackGroups !== nextState.stackGroups || this.state.tooltipTicks !== nextState.tooltipTicks || this.state.orderedTooltipTicks !== nextState.orderedTooltipTicks || this.state.tooltipAxis !== nextState.tooltipAxis) {
          this.clearCanvas();
        }
      }
    }, {
      ...
      */
      ...
      value: function clearCanvas() {
        ...
        var canvasChart = (0, _d3Selection.select)("canvas#".concat(canvasId));

        if (canvasChart && canvasChart.node()) {
          var context = canvasChart.node().getContext('2d');
      ...
      */
            ...
            if (dataKey) {
              ...
              if (type === 'category' && isCategorial) {
                ...
                if (!allowDuplicatedCategory) {
                  domain = (0, _ChartUtils.parseDomainOfCategoryAxis)(child.props.domain, domain, child).reduce(function (finalDomain, entry) {
                    return finalDomain.indexOf(entry) >= 0 || entry === '' || (0, _isNil2.default)(entry) ? finalDomain : _toConsumableArray(finalDomain).concat([entry]);
                  }, []);
                } else {
      ...
      value: function getMouseInfo(event) {
        ...
        if (eventType === 'single') {
          // scatterplot
          var formatedGraphicalItems = this.state.formatedGraphicalItems; // scatters

          var active = formatedGraphicalItems.reduce(function (closestPoint, cur) {
            var closestInScatter = cur.props.points.reduce(function (closest, point) {
              var dist = Math.hypot(point.cx - e.chartX, point.cy - e.chartY);
          ...
          if (active.dist > 25) return _objectSpread({}, e, {
            activeCoordinate: null,
            activePayload: null
          });
          return _objectSpread({}, e, {
            activeCoordinate: active.point.tooltipPosition,
            activePayload: active.point.tooltipPayload
          });
        }
      ...
      value: function parseEventsOfWrapper() {
        ...
        var tooltipItem = (0, _ReactUtils.findChildByType)(children, _Tooltip.default);
        var tooltipEvents = tooltipItem && (eventType === 'axis' || eventType === 'single') ? {
      ...
      value: function filterFormatItem(item) {
      ...
      value: function renderCanvas() {
        var _this$props7 = this.props,
            ...
            canvasId = _this$props7.canvasId;
      ...
      value: function render() {
        ...
        var _this$props8 = this.props,
            ...
            compact = _this$props8.compact,
            others = _objectWithoutProperties(_this$props8, ["children", "className", "width", "height", "style", "compact"]);
        ...
        }), this.props.canvas ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Surface.default, _extends({}, attrs, {
          width: width,
          height: height
        }), this.renderClipPath(), children && children.length && (0, _ReactUtils.renderByOrder)(children.filter(function (c) {
          return c && c.type && c.type.name && map[c.type.name].layer === 'bottom';
        }), map)), this.renderCanvas(), _react.default.createElement(_Surface.default, _extends({}, attrs, {
          width: width,
          height: height
        }), this.renderClipPath(), children && children.length && (0, _ReactUtils.renderByOrder)(children.filter(function (c) {
          return !(c && c.type && c.type.name && map[c.type.name].layer === 'bottom');
        }), map))) : _react.default.createElement(_Surface.default, _extends({}, attrs, {
          width: width,
          height: height
  ...
  CategoricalChartWrapper.propTypes = _objectSpread({
    ...
    canvas: _propTypes.default.bool,
