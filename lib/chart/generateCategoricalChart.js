      ...
      */
      ...
      value: function render() {
        ...
        return _react.default.createElement("div", _extends({
          ...
          width: width,
          height: height
        }), this.renderClipPath(), children && children.length && (0, _ReactUtils.renderByOrder)(children, map, function (componentType) {
          return map[componentType].layer === 'bottom';
        })), this.renderCanvas(), _react.default.createElement(_Surface.default, _extends({}, attrs, {
          width: width,
          height: height
        }), this.renderClipPath(), children && children.length && (0, _ReactUtils.renderByOrder)(children, map, function (componentType) {
          return map[componentType].layer !== 'bottom';
