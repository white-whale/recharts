...
var filterSvgAttributes = function filterSvgAttributes(props) {
  if (props) {
...
exports.filterSvgAttributes = filterSvgAttributes;
...
var renderByOrder = function renderByOrder(children, renderMap, filter) {
  var elements = [];
  var record = {};
  ...
  _react.Children.forEach(children, function (child, index) {
    ...
    if (isSvgElement(child)) {
      elements.push(child);
    } else if (renderMap[getDisplayName(child.type)]) {
