...
function (_Component) {
  ...
  _createClass(Pie, [{
    ...
    value: function renderLabels(sectors) {
      ...
      var pieProps = (0, _ReactUtils.filterSvgAttributes)((0, _ReactUtils.getPresentationAttributes)(this.props));
    ...
    value: function renderSectors() {
      ...
      if (isAnimationActive && sectors && sectors.length && (!prevSectors || !(0, _isEqual2.default)(prevSectors, sectors)) && !canvas) {
