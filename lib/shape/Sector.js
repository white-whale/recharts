...
var convertToD3Angle = function convertToD3Angle(degrees) {
...
var Sector = (0, _PureRender.default)(_class = (_temp = _class2 =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(Sector, [{
    ...
    value: function getArcFunction() {
      ...
      return (0, _d3Shape.arc)().innerRadius(innerRadius).outerRadius(outerRadius).cornerRadius(cornerRadius).startAngle(convertToD3Angle(startAngle)).endAngle(convertToD3Angle(endAngle));
    }
  }, {
    key: "renderSectorToCanvas",
    value: function renderSectorToCanvas() {
      ...
      var arcFunction = this.getArcFunction();
    ...
    value: function render() {
      var _this$props3 = this.props,
          cx = _this$props3.cx,
          cy = _this$props3.cy,
          innerRadius = _this$props3.innerRadius,
          outerRadius = _this$props3.outerRadius,
          startAngle = _this$props3.startAngle,
          endAngle = _this$props3.endAngle,
      ...
      var layerClass = (0, _classnames.default)('recharts-sector', className); // const deltaRadius = outerRadius - innerRadius;
      ...
      if (!canvas || !canvasId) {
        var path = this.getArcFunction()();
        return _react.default.createElement("path", _extends({}, (0, _ReactUtils.filterSvgAttributes)((0, _ReactUtils.getPresentationAttributes)(this.props)), (0, _ReactUtils.filterEventAttributes)(this.props), {
  ...
  return Sector;
}(_react.Component), _class2.displayName = 'Sector', _class2.propTypes = _objectSpread({}, _ReactUtils.PRESENTATION_ATTRIBUTES, {
