...
function (_Component) {
  ...
  _createClass(Curve, [{
    ...
    value: function renderCanvas() {
      ...
      if ((0, _isArray2.default)(baseLine) || (0, _DataUtils.isNumber)(baseLine)) {
        var formatBaseLine = connectNulls ? baseLine.filter(function (base) {
          return defined(base);
        }) : baseLine;
    ...
    value: function render() {
      ...
      if (!canvas || !canvasId) {
        ...
        return _react.default.createElement("path", _extends({}, (0, _ReactUtils.filterSvgAttributes)((0, _ReactUtils.getPresentationAttributes)(this.props)), (0, _ReactUtils.filterEventAttributes)(this.props, null, true), {
