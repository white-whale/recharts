...
function (_Component) {
  ...
  _createClass(Bar, [{
    ...
    value: function renderRectangles() {
      ...
      if (isAnimationActive && data && data.length && (!prevData || !(0, _isEqual2.default)(prevData, data)) && !canvas) {
    ...
    value: function renderBackground() {
      ...
      return data.map(function (entry, i) {
        ...
        return _this4.constructor.renderRectangle(_this4.props.background, _objectSpread({}, props, {
          canvas: false
        }));
      });
    }
