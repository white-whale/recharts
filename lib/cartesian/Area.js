...
function (_Component) {
  ...
  _createClass(Area, [{
    ...
    value: function renderDots(needClip, clipPathId) {
      ...
      var areaProps = (0, _ReactUtils.filterSvgAttributes)((0, _ReactUtils.getPresentationAttributes)(this.props));
    ...
    value: function renderArea(needClip, clipPathId) {
      ...
      if (isAnimationActive && points && points.length && (!prevPoints && totalLength > 0 || !(0, _isEqual2.default)(prevPoints, points) || !(0, _isEqual2.default)(prevBaseLine, baseLine)) && !canvas) {
